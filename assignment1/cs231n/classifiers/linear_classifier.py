...
class LinearClassifier(object):
  ...
  def train(self, X, y, learning_rate=1e-3, reg=1e-5, num_iters=100,
            batch_size=200, verbose=False, replace=True):
    """
  ...
  def predict(self, X):
    ...
    ###########################################################################
    scores = np.dot(X,self.W) #We have generated 'optimal' W using our loss function of choice. Now that we have this W, check how well it predicts.
