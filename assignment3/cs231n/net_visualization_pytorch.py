...
def compute_saliency_maps(X, y, model):
    ...
    ################
    #I misinterpreted 'loss' here I think, should have just computed my own 'loss' by summing scores of correct class
    #my approach below of using cross_entropy also gave good saliency maps, because cross-entropy loss automatically selects value for correct class
